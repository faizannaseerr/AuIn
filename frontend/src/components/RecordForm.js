...
const RecordForm = (props) => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} className='border-4 border-[#000003] px-8 py-12 border-double shadow-md shadow-zinc-300 rounded-sm'>
            <form className='flex flex-col max-w-[50rem]'>
                <div className="font-source font-medium mb-6">{summary}</div>
